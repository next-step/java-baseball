...
public class BallsTest {
	...
	void play_nothing() {
		...
		PlayRequest result = answers.play(Arrays.asList(4, 5, 6));
	...
	void play_1strike_1ball() {
		Balls answers = new Balls(Arrays.asList(1, 2, 3));
		PlayRequest result = answers.play(Arrays.asList(1, 4, 2));
	...
	void play_3strike() {
		Balls answers = new Balls(Arrays.asList(1, 2, 3));
		PlayRequest result = answers.play(Arrays.asList(1, 2, 3));
