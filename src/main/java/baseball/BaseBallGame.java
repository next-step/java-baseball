...
public class BaseBallGame {
    ...
    public int judgeStrikeOrBall(JudgmentStrikeOrBall r, String answer, String numbers) {
        int cnt = 0;

        for (int i = 0; i < answer.length(); i++) {
            cnt += JudgmentService.judge(r, numbers.indexOf(String.valueOf(answer.charAt(i))),i);
        }
