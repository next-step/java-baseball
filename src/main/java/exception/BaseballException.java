...
public class BaseballException {
    ...
    public static final String OUT_OF_RANGE_NUMBER_ERROR = "1~9 사이 숫자로 구성 되어야 합니다.";
    public static final String DIGITS_ERROR = "세자릿수이여야 합니다.";
    public static final String DUPLICATED_ERROR = "각 자릿수의 숫자는 중복되지 않아야 합니다.";
    public static final String RESTART_ERROR = "1 또는 2만 입력 가능합니다.";
    public static final String PARSE_NUMBER_ERROR = "문자열을 숫자로 변환할 수 없습니다.";
