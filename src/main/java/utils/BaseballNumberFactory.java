...
public class BaseballNumberFactory {
	...
	public BaseballNumberFactory() {
		for (int i = BaseballNumbers.MINIMUM_NUMBER_OF_BASEBALL_GAME;
			 i < BaseballNumbers.MAXIMUM_NUMBER_OF_BASEBALL_GAME + 1; i++) {
	...
	public BaseballNumbers generateNumbers() {
		...
		List<BaseballNumber> shuffledAndFilteredBaseballNumber = RAW_BASEBALL_NUMBERS.subList(0,
			BaseballNumbers.NUMBER_OF_BASEBALL_GAME);
