...
public final class Constants {
	...
	public static final String NO_BALL_NO_STRIKE = "포볼";
	...
	public static final String INPUT_EXCEPTION_MESSAGE = "다시 입력하세요 : ";
	public static final String ERR_RANGE_VALUE = "값 범위";
	public static final String ERR_LENGTH_VALUE = "값 길이";
	public static final String ERR_DUP_VALUE = "값 중복";
}
